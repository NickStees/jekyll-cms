...
<section id="feature">
  <div class="row">
    <div class="content col-md-6 col-md-offset-6">
      ...
      <p>{{ site.data.home.feature-subtitle }}</p>
      ...
      <div class="col-md-6">
        <div class="testimonial-carousel">
          <div id="testimonial-slider" class="owl-carousel">
            <div>
                <p><i class="fa fa-quote-left" aria-hidden="true"></i> Shoutout to the {{site.data.business.name}} for such a great demo. <i class="fa fa-quote-right" aria-hidden="true"></i></p>
                <div class="user">
            ...
            <div>
                <p><i class="fa fa-quote-left" aria-hidden="true"></i> Static sites are security fortresses! <i class="fa fa-quote-right" aria-hidden="true"></i> </p>
                <div class="user">
            ...
            <div>
                <p><i class="fa fa-quote-left" aria-hidden="true"></i> I love not having a CMS to have to update all the time. <i class="fa fa-quote-right" aria-hidden="true"></i> </p>
                <div class="user">
